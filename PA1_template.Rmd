...
```{rTimeSeriesAverageStepsByInterval}
...
Plot + geom_line(size = 1, linetype = 1) + labs(title = "Average Steps By Interval") + 
      labs(x = "Interval", y = "Average Steps Over All Days")

```

####PART 2 - Find the interval with the maximum average steps over all days.
```{rFindIntervalWithMaximumSteps}
...
FitDataPlus$weekend <- if_else(FitDataPlus$day %in% c("Saturday", "Sunday"), 
      "Weekend", "Weekday")
